  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Attributs content Add</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('admin/attribute')}}">Attributs content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Attributs content Add</li>
         </ol>
     </div>
      <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="add_attributes" action="{{ route('attribute_add')}}" enctype="multipart/form-data" method="post">
              @csrf
             
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">Attribute(English)</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" maxlength="50" id="name_en" name="name_en" value="{{old('name_en')}}">
                  </div>
                  @error('name_en')
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" maxlength="50" id="name_ar" name="name_ar" value="{{old('name_ar')}}">
                  </div>
                  @error('name_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                <strong>{{ $message }}</strong>
