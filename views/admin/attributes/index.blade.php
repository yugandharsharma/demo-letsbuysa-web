  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Attributes content Tables</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Attributes content List</li>
         </ol>
     </div>
     <div class="col-sm-3">
       <a href="{{url('admin/attribute/add')}}">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Attributes List</div>
            <div class="card-body">
                ...
                <tbody>
                  @if($attribute)
                    ...
                    <tr>
                        ...
                        <td>
                        @if(auth()->user()->role === 1)
                          <a href="{{ url('/')}}/admin/attribute/delete/{{$record->id}}">
                          ...
                          <a href="{{ url('/')}}/admin/attribute/edit/{{$record->id}}">
                        ...
                        @php $permission = permission(); @endphp
                                    ...
                                    @if(auth()->user()->role === 3 && isset($permission['attributes']) && $permission['attributes']['delete'] === 1)
                                <a href="{{ url('/')}}/admin/attribute/delete/{{$record->id}}">
                                    <button onclick="return confirm('are you want to delete this record');" type="button" class="btn btn-danger waves-effect waves-light m-1"> <i class="fa fa-trash-o"></i> </button></a>
                                    @endif
                                    @if(auth()->user()->role === 3 && isset($permission['attributes']) && $permission['attributes']['edit'] === 1)
                                <a href="{{ url('/')}}/admin/attribute/edit/{{$record->id}}">
                                    <button type="button" class="btn btn-success waves-effect waves-light m-1"> <i class="fa fa-pencil"></i> </button></a>
                                    @endif
                        </td>
