  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Option Edit</h4>
        <ol class="breadcrumb">
     ...
     <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="optionadd" action="{{ route('option_edit',$option->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('name_en') is-invalid @enderror" value= "{{$option->name_en}}" maxlength="150" id="name_en" name="name_en" required>
                  </div>
                </div>
                 @error('name')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" value= "{{$option->name_ar}}" maxlength="150" id="name_ar" name="name_ar" required>
                  </div>
                </div>
                 @error('name')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
             ...
             <div class="clone2 hide">
              <div class="control-group input-group" style="margin-top:10px">
               <input type="text" name="option_value_name_en[]" class="form-control" value ="{{$values->option_value_name_en}}" placeholder="Enter Option Value Name English">
               <input type="text" name="option_value_name_ar[]" class="form-control" value ="{{$values->option_value_name_ar}}" placeholder="Enter Option Value Name Arabic">
               <input type="text" name="option_value[]" class="form-control" value ="{{$values->value}}" placeholder="Enter Option Value">
               <input type="hidden" name="optionid[]" value ="{{$values->id}}" >
                <div class="input-group-btn"> 
                  <button class="btn btn-danger removepdf" type="button"><i class="glyphicon glyphicon-remove"></i> Remove</button>
                </div>
              </div>
