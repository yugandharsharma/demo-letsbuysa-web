  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Banner content Tables</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Banner content List</li>
         </ol>
     </div>
     <div class="col-sm-3">
                ...
                <tbody>
                  @if($banner)
                    ...
                    <tr>
                        ...
                        <td>
                            @if(auth()->user()->role === 1)
                          <a href="{{ url('/')}}/admin/banner/delete/{{$record->banner_id}}">
                          ...
                          <a href="{{ url('/')}}/admin/banner/edit/{{$record->banner_id}}">
                          ...
                          @endif
                                @php $permission = permission(); @endphp
                                    ...
                                    @if(auth()->user()->role === 3 && isset($permission['banners']) && $permission['banners']['delete'] === 1)
                                        <a href="{{ url('/')}}/admin/banner/delete/{{$record->banner_id}}">
                                            <button onclick="return confirm('are you want to delete this record');" type="button" class="btn btn-danger waves-effect waves-light m-1"> <i class="fa fa-trash-o"></i> </button></a>
                                    @endif
                                    @if(auth()->user()->role === 3 && isset($permission['banners']) && $permission['banners']['edit'] === 1)
                                        <a href="{{ url('/')}}/admin/banner/edit/{{$record->banner_id}}">
                                            <button type="button" class="btn btn-success waves-effect waves-light m-1"> <i class="fa fa-pencil"></i> </button></a>
                                    @endif
