  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Banner content Add</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{url('admin/banner')}}">Banner content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Banner content Add</li>
         </ol>
     </div>
     <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="addofferbanner" action="{{ route('add_banner')}}" enctype="multipart/form-data" method="post">
              @csrf
