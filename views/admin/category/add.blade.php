  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Category content Add</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('admin/category')}}">Category content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Category content Add</li>
         </ol>
     </div>
       <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="addcategory" action="{{ route('add_category')}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('category_name_en') is-invalid @enderror" value="{{old('category_name_en')}}" maxlength="50" id="category_name_en" name="category_name_en" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('category_name_ar') is-invalid @enderror" value="{{old('category_name_ar')}}" maxlength="50" id="category_name_ar" name="category_name_ar" >
                  </div>
                </div>
                ...
                @enderror
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_description_en') is-invalid @enderror" maxlength="250" id="meta_tag_description_en" name="meta_tag_description_en"value="{{old('meta_tag_description_en')}}"  >
                  </div>
                </div>
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_description_ar') is-invalid @enderror" row='4' maxlength="250" id="meta_tag_description_ar" name="meta_tag_description_ar" value="{{old('meta_tag_description_ar')}}">
                  </div>
                </div>
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_keyword_en') is-invalid @enderror" maxlength="250" id="meta_tag_keyword_en" name="meta_tag_keyword_en" value="{{old('meta_tag_keyword_en')}}">
                  </div>
                </div>
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_keyword_ar') is-invalid @enderror" maxlength="250" id="meta_tag_keyword_ar" name="meta_tag_keyword_ar" value="{{old('meta_tag_keyword_ar')}}">
                  </div>
                </div>
