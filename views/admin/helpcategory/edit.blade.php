  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Help Category content Edit</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('admin/help_category')}}">Help Category content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Help Category content Edit</li>
         </ol>
     </div>
       <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                   <form id="addhelpcategory" action="{{ route('help_category_edit',$category->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('name_en') is-invalid @enderror" maxlength="50" id="name_en" name="name_en" value="{{$category->name_en}}">
                  </div>
                </div>
                 @error('name_en')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" maxlength="50" id="name_ar" name="name_ar" value="{{$category->name_ar}}">
                  </div>
                </div>
                 @error('name_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="file" name="image_en" class="form-control @error('image_en') is-invalid @enderror" value="{{old('image_en')}}">
                     <img src="{{ url('/') }}/public/images/help/{{$category->image_en}}"  alt="User Image" width="150">
                  </div>
                @error('image_en')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                <strong>{{ $message }}</strong>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="file" name="image_ar" class="form-control @error('image_ar') is-invalid @enderror" value="{{old('image_ar')}}">
                     <img src="{{ url('/') }}/public/images/help/{{$category->image_ar}}"  alt="User Image" width="150">
                  </div>
                @error('image_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                <strong>{{ $message }}</strong>
