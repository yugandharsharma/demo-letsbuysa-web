  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Help Category content Tables</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Help Category content List</li>
         </ol>
     </div>
      @php $permission = permission(); @endphp
      @if(auth()->user()->role === 3 && isset($permission['help']) && $permission['help']['add'] === 1)
     <div class="col-sm-3">
       <a href="{{url('admin/help_category/add')}}">
     ...
     @endif
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>Help Category List</div>
            <div class="card-body">
             ...
             <table id="list" class="table table-bordered">
                <thead>
                    <tr>
                        <th>S.No</th>
                        <th>Help Category Name English</th>
                        <th>Help Category Name Arabic</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                  @if($category)
                    ...
                    <tr>
                        ...
                        <td>
                          @if(auth()->user()->role === 1)
                          <a href="{{ url('/')}}/admin/help_category/delete/{{$record->id}}">
                          ...
                          <a href="{{ url('/')}}/admin/help_category/edit/{{$record->id}}">
