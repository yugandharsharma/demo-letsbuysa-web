     ...
     <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="coloradd" action="{{ route('color_edit',$colors->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" maxlength="150" id="name" name="name" value ="{{$colors->name}}" required>
                  </div>
                </div>
                 @error('name')
                ...
                <div class="form-group row">
                  ...
                  <div id="cp2" class="input-group colorpicker colorpicker-component"> 
                      <input type="text" value="{{$colors->colorcode}}" name="colorcode" class="form-control" /> 
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                        <option value="1"<?php if ($colors->status=='1') {echo 'selected';}?>>Enabled</option>
                        <option value="2"<?php if ($colors->status=='2') {echo 'selected';}?>>Disabled</option>
                    </select>
                  </div>
                </div>
