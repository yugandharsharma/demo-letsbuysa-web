  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Hot-Deal content Edit</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{url('admin/hot_deal')}}">Hot-Deal content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Hot-Deal content Edit</li>
         </ol>
     </div>
     <div class="col-sm-3">
       <a href="{{url('admin/hot_deal')}}">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="editofferbanner" action="{{ route('edit_hotdeal',$banner->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                @enderror
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/hotdeal/{{$banner->image_en}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_en')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/hotdeal/{{$banner->image_ar}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('url') is-invalid @enderror" value="{{$banner->url}}" maxlength="150" id="url" name="url">
                  </div>
                </div>
                 @error('url')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('category_id') is-invalid @enderror" value="{{$banner->category_id}}" maxlength="150" id="category_id" name="category_id">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('subcategory_id') is-invalid @enderror" value="{{$banner->subcategory_id}}" maxlength="150" id="subcategory_id" name="subcategory_id">
                    </div>
                </div>
                ...
                <div class="form-footer">
                    <a href ="{{ url('admin/hot_deal')}}" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</a>
