  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Help SubCategory content Tables</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Help SubCategory content List</li>
         </ol>
     </div>
     @php $permission = permission(); @endphp
      @if(auth()->user()->role === 3 && isset($permission['help']) && $permission['help']['add'] === 1)
     <div class="col-sm-3">
       <a href="{{url('admin/help_subcategory/add')}}">
     ...
     @endif
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>Help Subcategory List</div>
            <div class="card-body">
             ...
             <table id="list" class="table table-bordered">
                <thead>
                    <tr>
                        <th>S.No</th>
                        <th>Help Subcategory Name English</th>
                        <th>Help Subcategory Name Arabic</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                  @if($subcategory)
                    ...
                    <tr>
                        ...
                        <td>
                          @if(auth()->user()->role === 1)
                          <a href="{{ url('/')}}/admin/help_subcategory/delete/{{$record->id}}">
                          ...
                          <a href="{{ url('/')}}/admin/help_subcategory/edit/{{$record->id}}">
                          <button type="button" class="btn btn-success waves-effect waves-light m-1"> <i class="fa fa-pencil"></i> </button></a>
                          @endif

                          @php $permission = permission(); @endphp
                          @if(auth()->user()->role === 3 && isset($permission['help']) && $permission['help']['delete'] === 1)
                            <a href="{{ url('/')}}/admin/help_subcategory/delete/{{$record->id}}">
                          <button onclick="return confirm('are you want to delete this record');" type="button" class="btn btn-danger waves-effect waves-light m-1"> <i class="fa fa-trash-o"></i> </button></a>
                          @endif
                          @if(auth()->user()->role === 3 && isset($permission['help']) && $permission['help']['edit'] === 1)
                             <a href="{{ url('/')}}/admin/help_subcategory/edit/{{$record->id}}">
                          <button type="button" class="btn btn-success waves-effect waves-light m-1"> <i class="fa fa-pencil"></i> </button></a>
                          @endif
                        </td>
