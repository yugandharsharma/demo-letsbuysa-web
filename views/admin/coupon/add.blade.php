     ...
     <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="addcoupon" action="{{ route('add_coupon')}}" enctype="multipart/form-data" method="post">
              @csrf
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label"> Coupon Name</label>
                  <div class="col-sm-10">
                    <input type="text" placeholder="Enter Coupon Name" class="form-control @error('coupon_name') is-invalid @enderror" maxlength="100" id="coupon_name" name="coupon_name" value="{{old('coupon_name')}}">
                  </div>
                </div>
                 @error('coupon_name')
                ...
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label" data-toggle="tooltip" title="The code the customer enters to get the discount">Code <i class="fa fa-question-circle" style="color:aqua" aria-hidden="true"></i></label>
                  <div class="col-sm-10">
                    <input type="text" placeholder="Enter Coupon Code" class="form-control @error('code') is-invalid @enderror" maxlength="70" id="code" name="code" value="{{old('code')}}">
                  </div>
                </div>
                 @error('code')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" placeholder="Enter Discount" class="form-control @error('discount') is-invalid @enderror" id="discount" name="discount" value="{{old('discount')}}">
                  </div>
                </div>
                 @error('discount')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control @error('total_amount') is-invalid @enderror" id="total_amount" placeholder="Enter Total Amount" name="total_amount" value="{{old('total_amount')}}">
                  </div>
                </div>
                 @error('total_amount')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <select class="form-control multiple-select" multiple="multiple" name="subcategories[]">
                          ...
                          <option value="{{$value->id}}">Collect Of {{$value->sub_category_name_en}}</option>
                          @endforeach
                          @endif
                      </select>
                    </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" maxlength="50" value="{{old('start_date')}}" placeholder="Select Start Date" class="form-control" id="start_date" name="start_date">
                  </div>
                </div>
                 @error('start_date')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" maxlength="50" value="{{old('end_date')}}" placeholder="Select End Date" class="form-control" id="end_date" name="end_date">
                  </div>
                </div>
                 @error('end_date')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" maxlength="50" value="@if(old('uses_per_coupon')){{old('uses_per_coupon')}}@else{{'1'}}@endif" placeholder="Enter Uses Per Customer" class="form-control" id="uses_per_coupon" name="uses_per_coupon">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" maxlength="50" value="@if(old('uses_per_coupon')){{old('uses_per_customer')}}@else{{'1'}}@endif" placeholder="Enter Uses Per Customer" class="form-control" id="uses_per_customer" name="uses_per_customer" value="1">
                  </div>
                </div>
