  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Filter content Tables</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Filter content List</li>
         </ol>
     </div>
     <!-- <div class="col-sm-3">
       <a href="{{url('admin/filter/add')}}">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Filter List</div>
            <div class="card-body">
                ...
                <tbody>
                  @if($filter)
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- @if(auth()->user()->role === 1) -->
                          <a href="{{ url('/')}}/admin/filter/delete/{{$record->id}}">
                          ...
                          <a href="{{ url('/')}}/admin/filter/edit/{{$record->id}}">
                         ...
                         <!-- @endif -->
                                ...
                                @if(auth()->user()->role === 3 && isset($permission['options']) && $permission['options']['delete'] === 1)
                                    <a href="{{ url('/')}}/admin/option/delete/{{$record->id}}">
                                        <button onclick="return confirm('are you want to delete this record');" type="button" class="btn btn-danger waves-effect waves-light m-1"> <i class="fa fa-trash-o"></i> </button></a>
                                @endif
                                @if(auth()->user()->role === 3 && isset($permission['options']) && $permission['options']['edit'] === 1)
                                    <a href="{{ url('/')}}/admin/option/edit/{{$record->id}}">
                                        <button type="button" class="btn btn-success waves-effect waves-light m-1"> <i class="fa fa-pencil"></i> </button></a>
                                @endif -->
                        </td>
                    </tr>
