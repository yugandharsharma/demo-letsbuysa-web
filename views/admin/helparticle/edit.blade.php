  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Help Article content Edit</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('admin/help_article')}}">Help Article content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Help Article content Edit</li>
         </ol>
     </div>
       <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                   <form id="addhelpcategory" action="{{ route('help_article_edit',$article->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                <div class="form-group row">
                    <label for="input-1" class="col-sm-2 col-form-label">Help Category Name<span style="color: red; font-size: 14px;">*</span></label>
                      <div class="col-sm-10">
                        ...
                        <option value="{{ $record->id }}" {{ $article->category_id == $record->id ? "selected" : "" }}>{{ $record->name_en}}</option> 
                        @endforeach
                      </select>
                    </div>
                 @error('category_id')
                ...
                <div class="form-group row">
                    <label for="input-1" class="col-sm-2 col-form-label">Help Sub Category Name<span style="color: red; font-size: 14px;">*</span></label>
                      ...
                      <select class="form-control @error('subcategory_id') is-invalid @enderror " id="subcategory_id" name="subcategory_id" required="">
                        ...
                        <option value="{{ $record->id }}" {{ $article->subcategory_id == $record->id ? "selected" : "" }}>{{ $record->name_en}}</option> 
                        @endforeach
                      </select>
                    </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('title_en') is-invalid @enderror" maxlength="50" id="title_en" name="title_en" value="{{$article->title_en}}">
                  </div>
                </div>
                 @error('title_en')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('title_ar') is-invalid @enderror" maxlength="50" id="title_ar" name="title_ar" value="{{$article->title_ar}}">
                  </div>
                </div>
                 @error('title_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea class="textarea" class="form-control @error('description_en') is-invalid @enderror" placeholder=" Description" id='editor1' name="description_en" style="width: 100%; height: 300px; font-size: 14px; line-height: 20px; border: 1px solid #dddddd; padding: 10px;">{{$article->description_en}}</textarea>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <textarea class="textarea" class="form-control @error('description_ar') is-invalid @enderror" placeholder=" Description" id='editor2' name="description_ar" style="width: 100%; height: 300px; font-size: 14px; line-height: 20px; border: 1px solid #dddddd; padding: 10px;">{{$article->description_ar}}</textarea>
                  </div>
                </div>
