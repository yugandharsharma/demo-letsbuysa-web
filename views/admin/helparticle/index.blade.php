  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Help Article content Tables</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Help Article content List</li>
         </ol>
     </div>
      @php $permission = permission(); @endphp
      @if(auth()->user()->role === 3 && isset($permission['help']) && $permission['help']['add'] === 1)
     <div class="col-sm-3">
       <a href="{{url('admin/help_article/add')}}">
     ...
     @endif
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>Help Article List</div>
            <div class="card-body">
                ...
                <tbody>
                  @if($articles)
                    ...
                    <tr>
                        ...
                        <td>
                        @if(auth()->user()->role === 1)
                          <a href="{{ url('/')}}/admin/help_article/delete/{{$record->id}}">
                          ...
                          <a href="{{ url('/')}}/admin/help_article/edit/{{$record->id}}">
