  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">User Cart content Tables</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">User Cart content List</li>
         </ol>
     </div>
     </div>
        <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> User Cart List</div>
            <div class="card-body">
                ...
                <tbody>
                  @if($user)
                    ...
                    <tr>
                        ...
                        <td>{{$record['email']}}</td>
                        <td>
                          <a href="{{route('user_cart_view', base64_encode($record['user_id']))}}">
