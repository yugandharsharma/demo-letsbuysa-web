...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <h4 class="page-title">Hot Today Add</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{route('hot_today_list')}}">Hot Today Management</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Hot Today Add</li>
                </ol>
            </div>
            <div class="col-sm-3">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="addhottoday" action="{{route('hot_today_add')}}" enctype="multipart/form-data" method="post">
                            @csrf
