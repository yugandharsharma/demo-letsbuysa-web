  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Side-Banner content Edit</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{url('admin/side_banner')}}">Side-Banner content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Side-Banner content Edit</li>
         </ol>
     </div>
     <div class="col-sm-3">
       <a href="{{url('admin/side_banner')}}">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="editofferbanner" action="{{ route('edit_side_banner',$banner->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                @enderror
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/side-banner/{{$banner->image_en}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_en')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/side-banner/{{$banner->image_ar}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
