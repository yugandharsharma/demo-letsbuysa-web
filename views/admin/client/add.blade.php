  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Side-Banner content Add</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{url('admin/side_banner')}}">Side-Banner content Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Side-Banner content Add</li>
         </ol>
     </div>
     <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="addofferbanner" action="{{ route('add_side_banner')}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                <div class="form-footer">
                    <a href ="{{ url('admin/side_banner')}}" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</a>
