    ...
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard')}}">About us Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">About us Edit</li>
         </ol>
     </div>
      <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
               <form id="editaboutus" action="{{ route('edit_aboutus')}}" enctype="multipart/form-data" method="post">
              @csrf
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label"> Title(English)</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('title_en') is-invalid @enderror" maxlength="100" id="title_en" name="title_en" value="<?php if(isset($aboutus->title_en)) { echo $aboutus->title_en;}?>">
                  </div>
                </div>
                 @error('title_en')
                ...
                @enderror
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('title_ar') is-invalid @enderror" maxlength="100" id="title_ar" name="title_ar" value="<?php if (isset($aboutus->title_ar)) {echo $aboutus->title_ar;}?>">
                  </div>
                </div>
                 @error('title_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/aboutus/<?php if (isset($aboutus->image_en)) {echo $aboutus->image_en;}?>"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_en')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/aboutus/<?php if (isset($aboutus->image_ar)) {echo $aboutus->image_ar;}?>"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_title_en') is-invalid @enderror" value="<?php if (isset($aboutus->meta_tag_title_en)) {echo $aboutus->meta_tag_title_en;}?>" maxlength="70" id="meta_tag_title_en" name="meta_tag_title_en" >
                  </div>
                </div>
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_title_ar') is-invalid @enderror" maxlength="70" id="meta_tag_title_ar" name="meta_tag_title_ar" value="<?php if (isset($aboutus->meta_tag_title_ar)) {echo $aboutus->meta_tag_title_ar;}?>">
                  </div>
                </div>
                ...
                @enderror
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_description_en') is-invalid @enderror" maxlength="250" id="meta_tag_description_en" name="meta_tag_description_en" value="<?php if (isset($aboutus->meta_tag_description_en)) {echo $aboutus->meta_tag_description_en;}?>">
                  </div>
                </div>
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_description_ar') is-invalid @enderror" row='4' maxlength="250" id="meta_tag_description_ar" name="meta_tag_description_ar" value="<?php if (isset($aboutus->meta_tag_description_ar)) {echo $aboutus->meta_tag_description_ar;}?>">
                  </div>
                </div>
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_keyword_en') is-invalid @enderror" maxlength="250" id="meta_tag_keyword_en" name="meta_tag_keyword_en" value="<?php if (isset($aboutus->meta_tag_keyword_en)) {echo $aboutus->meta_tag_keyword_en;}?>">
                  </div>
                </div>
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('meta_tag_keyword_ar') is-invalid @enderror" maxlength="250" id="meta_tag_keyword_ar" name="meta_tag_keyword_ar" value="<?php if (isset($aboutus->meta_tag_keyword_ar)) {echo $aboutus->meta_tag_keyword_ar;}?>">
                  </div>
                </div>
