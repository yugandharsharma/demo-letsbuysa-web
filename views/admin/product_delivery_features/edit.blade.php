  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Product Delivery Features Edit</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{url('admin/product_delivery_features')}}">Product Delivery Features Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Product Delivery Features Edit</li>
         </ol>
     </div>
     <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="productdeliveryfeatureedit" action="{{ route('product_delivery_edit',$data->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/product_images/{{$data->image_en}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_en')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                @enderror
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/product_images/{{$data->image_ar}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
