  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">User Groups Edit</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{url('admin/user_group')}}">User Groups Management</a></li>
            <li class="breadcrumb-item active" aria-current="page">User Groups Edit</li>
         </ol>
     </div>
     <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="usergroupedit" action="{{ route('user_group_edit',$data->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('title_en') is-invalid @enderror" value="{{$data->title_en}}" maxlength="150" id="title_en" name="title_en">
                  </div>
                </div>
                 @error('title_en')
                ...
                @enderror
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('title_ar') is-invalid @enderror" value="{{$data->title_ar}}" maxlength="150" id="title_ar" name="title_ar">
                  </div>
                </div>
                 @error('title_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                        <option value="1"<?php if ($data->status=='1') {echo 'selected';}?>>Enabled</option>
                        <option value="2"<?php if ($data->status=='2') {echo 'selected';}?>>Disabled</option>
                    </select>
                  </div>
                </div>
