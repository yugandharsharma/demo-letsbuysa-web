      ...
      <div class="col-sm-3">
       ...
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                <form id="editsubcategory" action="{{ route('edit_sub_category',$subcategory->id)}}" enctype="multipart/form-data" method="post">
              @csrf
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <option value="{{$record->id}}"<?php if ($subcategory['category_id']==$record->id) {echo 'selected';}?>>{{$record->category_name_en}}</option>
                    @endforeach
                  </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('sub_category_name_en') is-invalid @enderror" maxlength="250" id="sub_category_name_en" name="sub_category_name_en" value="{{$subcategory->sub_category_name_en}}" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('sub_category_name_ar') is-invalid @enderror" maxlength="250" id="sub_category_name_ar" name="sub_category_name_ar" value="{{$subcategory->sub_category_name_ar}}" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <select class="form-control multiple-select" multiple="multiple" name="productfilters[]">
                          ...
                          <option value="{{$value->id}}"<?php if(in_array($value->id,explode(',',$subcategory->productfilters))){echo "selected";} ?>>{{$value->filter_name_en}}</option>
                          @endforeach
                          @endif
                      </select>
                    </div>
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/subcategory/{{$subcategory->image_en}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_en')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="{{ url('/') }}/public/images/subcategory/{{$subcategory->image_ar}}"  alt="User Image" width="150">
                  </div>
                </div>
                @error('image_ar')
                <span class="invalid-feedback" style="color: red; display:block; padding-left:260px">
