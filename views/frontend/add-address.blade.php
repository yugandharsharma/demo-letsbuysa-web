  ...
  <div class="container">
    <nav class="breadcrumb-nav">
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#" ><?php echo  __('messages.add_address') ?></a></li>
      </ul>
    </nav>
  </div>
</section>
            ...
            @csrf
                <div class="account-form">
                    <div class="form-group">
                      <lable><?php echo  __('messages.fullname') ?></lable>
                      <input type="text" name="name" class="form-control" placeholder="<?php echo  __('messages.full_name') ?>">
                    </div>
                    @if($errors->has('name'))
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="address_details" class="form-control" placeholder="Extra details, known streets etc">
                    </div>
                    <input type="hidden" name="lat" id="lat">
                    <input type="hidden" name="long" id="long">
                    <input type="hidden" name="fulladdress" id="fulladdress">
                    <input type="hidden" name="samepage" value="0">
